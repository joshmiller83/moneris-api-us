...
class mpgHttpsPost {
  ...
  function mpgHttpsPost($storeid, $apitoken, $mpgRequestOBJ, $server = 'test', $cacert_path = '') {
...
class mpgRequest {
  ...
  var $txnTypes = array(
    ...
    'us_pinless_debit_purchase' => array(
      'order_id',
      'amount',
      'pan',
      'expdate',
    ...
    'us_res_ind_refund_ach' => array(
      'data_key',
      'order_id',
      'cust_id',
      'amount'
    ),
    'us_res_tokenize_cc' => array(
      'order_id',
      'txn_number',
      'cust_id',
      'phone',
    ...
    'us_enc_track2_ind_refund' => array(
      'order_id',
      'cust_id',
      'amount',
      'enc_track2',
    ...
    'us_enc_card_verification' => array(
      'order_id',
      'cust_id',
      'enc_track2',
      'device_type'
